...
let Cart = () => {
  ...
  return (
    <>
      {" "}
      {counter.mode == "light" ? ( // <div className="uppercontener">
                ...
                if (element.q == 0) {
                  return (
                    <div className="pro">
                      ...
                      <p>{element.title}</p>
                      <button
                        className="plush-button"
                        onClick={() => counter.plushFuntion(element)}
                      >
                        +
                      </button>
                      <p>{"Qunatity: " + element.q}</p>
                      <button
                        className="nagitive-button"
                        onClick={() => {
                          removed(element), counter.nagitiveFuntion(element);
                        }}
                      >
                        -
                      </button>
                  ...
                  return (
                    <div className="pro">
                      ...
                      <button
                        className="nagitive-button"
                        onClick={() => counter.nagitiveFuntion(element)}
                      >
                        -
                      </button>
                      <p>
        ...
        <div className="conteners" style={{ backgroundColor: "black" }}>
          ...
          <div className="totaldiv" style={{ backgroundColor: "#0F1A20" }}>
            ...
            <div
              style={{ display: styles, backgroundColor: "#0F1A20" }}
              className="totalcontener"
            >
            ...
            <div className="singleproduct">
              {counter.cart.map((element) => {
                if (element.q == 0) {
                  return (
                    <div
                      className={counter.mode == "light" ? "pro" : "pro-dark"}
                    >
                      <img
                        src={element.images}
                        height={100}
